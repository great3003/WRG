  ...
  setTimeout(() => {
    ...
    if (shareBtn)
      shareBtn.addEventListener("click", () => {
        const shareText = `I just scored ${score} points on WRG ⚡ Can you beat me? (miniapp link here)`;
...
// ✅ Other buttons automatically end the game
...
submitWord.addEventListener("click", async () => {
  if (!gameActive) return; // ✅ prevent input after game ends
...
async function checkAndMintBadge(weeklyScore, user) {
  const badgeMilestones = [
    { score: 1000, badge: "Wood I" }, { score: 2000, badge: "Wood II" }, { score: 3000, badge: "Wood III" },
    { score: 4500, badge: "Iron I" }, { score: 6000, badge: "Iron II" }, { score: 7500, badge: "Iron III" },
    { score: 10000, badge: "Bronze I" }, { score: 12000, badge: "Bronze II" }, { score: 14000, badge: "Bronze III" },
    { score: 17000, badge: "Silver I" }, { score: 19000, badge: "Silver II" }, { score: 21000, badge: "Silver III" },
    { score: 24000, badge: "Gold I" }, { score: 27000, badge: "Gold II" }, { score: 30000, badge: "Gold III" },
    { score: 32000, badge: "Platinum I" }, { score: 36000, badge: "Platinum II" }, { score: 40000, badge: "Platinum III" },
    { score: 44000, badge: "Diamond I" }, { score: 52000, badge: "Diamond II" }, { score: 60000, badge: "Diamond III" },
    { score: 70000, badge: "Master I" }, { score: 80000, badge: "Master II" }, { score: 90000, badge: "Master III" },
    { score: 100000, badge: "Grandmaster I" }, { score: 130000, badge: "Grandmaster II" }, { score: 150000, badge: "Grandmaster III" },
  ];
  ...
  const res = await fetch(`${API_BASE}/api/mintBadge`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ badge: earned.badge, score: weeklyScore, fid: user.fid, wallet: user.wallet, price_usd: 0.03 }),
  });
